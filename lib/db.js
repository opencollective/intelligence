...
const saveCollective = collective =>
  fs.readJson(collectivesFilename).then(collectives => {
    collectives[collective.id] = collective;
    return saveCollectives(collectives);
  });

const saveCollectives = db => fs.writeFile(collectivesFilename, jsonEncode(db));
...
exports.saveCollective = saveCollective;

exports.saveCollectives = saveCollectives;
